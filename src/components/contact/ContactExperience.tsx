...
export const ContactExperience: React.FC<ContactExperienceProps> = ({ initialService = '' }) => {
  ...
  return (
    <section id="contact" className="py-24 sm:py-32 bg-[#070809] border-t border-white/[0.08] relative">
      <div className="container-editorial">
        ...
        {/* Split Contact Layout with Fluid Rounded Glass Ergonomics */}
        <div className="mt-12 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="space-y-4">
              ...
              {/* Ashita Card */}
              <div className="p-6 rounded-3xl bg-[#0E1116]/80 backdrop-blur-xl border border-white/10 hover:border-[#E0581E]/40 transition-all duration-300 space-y-3 shadow-xl hover:-translate-y-0.5">
                ...
                <div className="space-y-2 font-mono text-xs pt-1">
                  <a
                    href={`tel:9483389387`}
                    className="flex items-center gap-2.5 text-[#F9F8F5] hover:text-[#E0581E] transition-colors p-2 rounded-xl bg-white/[0.02] border border-white/5"
                  >
              ...
              {/* Shashidhar Card */}
              <div className="p-6 rounded-3xl bg-[#0E1116]/80 backdrop-blur-xl border border-white/10 hover:border-[#E5B25D]/40 transition-all duration-300 space-y-3 shadow-xl hover:-translate-y-0.5">
                <div className="flex items-center justify-between">
                  <h4 className="font-serif text-xl font-bold text-[#F9F8F5]">
                    Shashidhar
                  </h4>
            ...
            <a
              ...
              className="p-4 rounded-2xl bg-[#0E1116]/80 backdrop-blur-md border border-[#25D366]/40 hover:border-[#25D366] text-[#25D366] font-mono text-xs flex items-center justify-between transition-all shadow-lg hover:scale-102 block"
            >
            ...
            {/* Registered Address Coordinates in Rounded Card */}
            <div className="p-6 rounded-3xl bg-[#0E1116]/80 backdrop-blur-xl border border-white/10 space-y-3 shadow-xl">
          ...
          {/* Right Column: Sample Request Form (7 cols) in Curved Glass Card */}
          <div className="lg:col-span-7 p-6 sm:p-8 rounded-3xl bg-[#0E1116]/80 backdrop-blur-2xl border border-white/10 shadow-2xl">
            {submitted ? (
              <div className="py-12 text-center space-y-4 animate-fadeIn">
                ...
                <p className="text-sm text-[#9DA3AF] max-w-md mx-auto font-sans">
                ...
                <button
                  ...
                  className="mt-6 px-7 py-3 rounded-full bg-white/[0.04] border border-white/15 text-xs font-mono text-[#F9F8F5] hover:border-[#E0581E] transition-all cursor-pointer hover:scale-105"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 rounded-2xl bg-black/40 border border-white/10 text-xs font-sans text-[#F9F8F5] placeholder-[#6B7A88] focus:outline-none focus:border-[#E0581E] transition-colors"
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-2.5 rounded-2xl bg-black/40 border border-white/10 text-xs font-mono text-[#F9F8F5] focus:outline-none focus:border-[#E0581E] transition-colors"
                    >
                      ...
                      <option value="Custom Flavour Development" className="bg-[#0E1116]">
                        Custom Flavour Development
                      </option>
                      <option value="General Institutional Sourcing" className="bg-[#0E1116]">
                ...
                <button
                  type="submit"
                  className="w-full py-4 rounded-full bg-gradient-to-r from-[#E0581E] to-[#F57E25] hover:brightness-110 text-[#070809] font-sans text-xs font-bold uppercase tracking-wider transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer shadow-xl shadow-[#E0581E]/30 hover:scale-102"
                >
                  <span>Submit Sample & Formulation Request</span>
                  <ArrowUpRight className="w-4 h-4 text-[#070809]" />
                </button>
